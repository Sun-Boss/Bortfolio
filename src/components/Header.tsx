                        ...
                        <div key={item.name} className="relative group">
                            ...
                            {item.name === "샘플보기" && (
                                <div className="absolute top-full left-0 mt-2 w-40 bg-background/95 backdrop-blur-md border border-white/10 rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform origin-top-left -translate-y-2 group-hover:translate-y-0 flex flex-col overflow-hidden">
                                    <Link href="/sample" className="px-4 py-3 hover:bg-white/5 transition-colors text-sm text-foreground/80 hover:text-primary-light-blue">메인페이지</Link>
                                    <Link href="/sample1" className="px-4 py-3 hover:bg-white/5 transition-colors text-sm text-foreground/80 hover:text-primary-light-blue">샘플1</Link>
                                    <Link href="/sample2" className="px-4 py-3 hover:bg-white/5 transition-colors text-sm text-foreground/80 hover:text-primary-light-blue">샘플2</Link>
